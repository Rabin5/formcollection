...
class CovidHospital(Hospital):
    ...
    type = models.CharField(max_length=255, verbose_name='वर्णन', blank=False, null=False)
    date_announcement = models.CharField(max_length=15, blank=False, null=False, verbose_name='मिति घोषित', default='01/01/2000')
