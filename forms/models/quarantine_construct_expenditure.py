...
class QuarantineConstructionExpenditure(FormBaseModel):
    ...
    Code: medExp
    """
    fiscal_year = models.ForeignKey(FiscalYear, on_delete=models.PROTECT, related_name='forms_quarantine_expense_fy', null=True, verbose_name='आर्थिक बर्ष: ')
    body = models.ForeignKey(GovernmentBody, on_delete=models.CASCADE, related_name="forms_quarantine_expense_gov", null=True, verbose_name='निकायको नामः: ')
